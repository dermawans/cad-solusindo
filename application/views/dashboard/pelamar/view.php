...
<?php echo form_open('','id="wizard" class="form-horizontal"'); ?> 
    ...
    ?>    
                								...
                								<table class="table table-hover table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        	<input type="text" name="status_aplikasi" value="<?php echo $row1->status_aplikasi; ?>" class="form-control number required" readonly="readonly"> 
                                                         </td> 
                                                    </tr>
                                                    </tbody>
                                                </table>
        ...
        <footer class="panel-footer">
            <div class="row">
                <div class="col-md-12 text-right">
                    <a href="<?php echo base_url(); ?>pelamar" class="btn btn-sm btn-warning">Kembali</a>
                </div>
            </div>
        </footer>
    </section>
